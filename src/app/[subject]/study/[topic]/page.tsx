...
import { StudyGuideView } from "@/components/study/study-guide-view"
import { getTopic } from "@/data/subjects"
import { markTopicStudied } from "@/lib/storage"
...
export default function StudyPage({ params }: StudyPageProps) {
  ...
  const handleMarkComplete = () => {
    markTopicStudied(`${subject}-${topic}`)
  }
